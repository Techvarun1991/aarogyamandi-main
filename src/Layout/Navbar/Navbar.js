...
//       <Disclosure
//         as="nav"
//         className="bg-gradient-to-b from-teal-200 to-teal-50"
//       >
//         <div className="grid grid-cols-8 grid-rows-1 h-32">
//           <div className="sm:items-stretch sm:justify-start mt-8 h-24">
//             <div className="flex space-x-8 flex-shrink-0 items-center w-96">
//               {isMobile ? null : (
//                 <img
...
//                   <div className="col-span-2 py-2 bg-slate-50 rounded-md">
//                     {" "}
...
//             </div>{" "}
//           </div>
//           <div className="col-start-8 row-start-1 mt-8 h-12 p-5">
...
//           </div>
//           <div
//             className={`col-span-2 col-start-4 row-start-1 h-12 mt-4 text-lg font-medium ${
//               isMobile ? "text-center text-xs font-bold" : ""
//             }`}
//           >
...
export default function Navbar() {
  ...
  return (
    <>
      {" "}
      <header className="bg-gradient-to-b from-teal-200 to-teal-50">
