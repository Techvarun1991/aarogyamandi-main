            ...
            .map((card) => (
              ...
              >
                <div className="bg-white p-4 shadow relative">
                  ...
                  />
                  <span className="absolute top-3 left-0 bg-pink-500 text-white px-2 py-1 rounded-r-md">
                    {card.label}
                  </span>
                  <div className="px-2 py-4">
                    ...
                    <p className="text-sm text-gray-400 text-left">
                      Best Price{" "}
                      <span className="text-pink-600">{card.bestPrice}</span>
                    </p>
                    <p className="text-sm text-gray-400 text-left">
                      MRP <span className="line-through">{card.mrp}</span>
                    </p>
                    <button className="font-bold text-teal-400 w-full mt-2">
                      ADD TO CART
                    </button>
                  </div>
                </div>
